...
DownloadFile::DownloadFile(const QString &url, const QString &saveDir, const QString &fileName, const QString &srcFilePath){
    this->url = url;
    ...
    if (!m_file->open(QIODevice::WriteOnly)) {
        QMessageBox::information(nullptr, "提示", "打开临时文件错误");
        return;
    }
}
